...
Bridge.assembly("AzureDay.Rome.Client", function ($asm, globals) {
    ...
    Bridge.define("Bridge.Spaf.ViewModels.RunViewModel", {
        ...
        methods: {
            ...
            GameHubOnOnPlayerLeaved: function (sender, e) {
                Bridge.global.alert(System.String.format("Il giocatore {0} della squadra {1} ci ha lasciato prematuramente.", e.Item1, e.Item2));
            },
            GameHubOnOnNewPlayerJoined: function (sender, e) {
                Bridge.global.alert(System.String.format("Nuovo giocatore {0} della squadra {1}", e.Item1, e.Item2));
            },
