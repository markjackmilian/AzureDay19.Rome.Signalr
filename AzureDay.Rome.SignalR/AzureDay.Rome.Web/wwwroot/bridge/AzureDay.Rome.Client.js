...
Bridge.assembly("AzureDay.Rome.Client", function ($asm, globals) {
    ...
    Bridge.define("AzureDay.Rome.Client.ViewModels.StartGameViewModel", {
        ...
        fields: {
            ...
            GameState: null,
            Team1Score: null,
            Team1ScreenPosition: null,
            Team2Score: null,
            Team2ScreenPosition: null,
            Team3Score: null,
            Team3ScreenPosition: null,
            Team4Score: null,
            Team4ScreenPosition: null
        },
        alias: [
            "OnLoad", "Bridge$Navigation$IAmLoadable$OnLoad",
            "OnLeave", "Bridge$Navigation$IAmLoadable$OnLeave"
        ...
        ctors: {
            ctor: function (gameHub, teamRepository) {
                ...
                this.Team1ScreenPosition = ko.observable();
                this.Team2ScreenPosition = ko.observable();
                this.Team3ScreenPosition = ko.observable();
                this.Team4ScreenPosition = ko.observable();


                this.Team1Score.subscribe(Bridge.fn.bind(this, function (value) {
                    this.Team1ScreenPosition(System.String.format("{0}px", [Bridge.box(value, System.Int32)]));
                }));
                this.Team2Score.subscribe(Bridge.fn.bind(this, function (value) {
                    this.Team2ScreenPosition(System.String.format("{0}px", [Bridge.box(value, System.Int32)]));
                }));
                this.Team3Score.subscribe(Bridge.fn.bind(this, function (value) {
                    this.Team3ScreenPosition(System.String.format("{0}px", [Bridge.box(value, System.Int32)]));
                }));
                this.Team4Score.subscribe(Bridge.fn.bind(this, function (value) {
                    this.Team4ScreenPosition(System.String.format("{0}px", [Bridge.box(value, System.Int32)]));
                }));
            }
        },
        methods: {
