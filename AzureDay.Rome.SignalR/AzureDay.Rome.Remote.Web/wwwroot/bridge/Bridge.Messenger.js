    ...
    Bridge.define("Bridge.Messenger.Messenger", {
        ...
        methods: {
            ...
            InnerSend: function (message, senderType, argType, sender, args) {
                ...
                var actionsCopy = System.Linq.Enumerable.from(actions).toList(Bridge.global.System.Object);
